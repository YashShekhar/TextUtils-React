    ...
    return (
        <>
            <div className='container'>
                ...
                <div className="mb-3">
                    <textarea className="form-control" onChange={handleOnChange} value={text} id="myBox" rows="8" style={getModeStyle(props.mode)}></textarea>
                </div>
            ...
            <div className="container my-3" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <p><i>You can read above text in {0.008 * text.split(/\s+/).filter((element) => { return element.length !== 0 }).length} Minutes</i></p>
                <h2>Preview</h2>
